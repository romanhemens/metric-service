...
```
cd existing_repo
git remote add origin https://git.se.informatik.uni-kiel.de/ExplorViz/code/metrics-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.se.informatik.uni-kiel.de/ExplorViz/code/metrics-service/-/settings/integrations)
